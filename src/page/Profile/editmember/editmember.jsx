...
function EditMember({ }) {
  ...
  // State for personal information form with default values
  const [userData, setUserData] = useState({
    name: "tester", // Default name
    email: "tester@gmail.com", // Default email
    phone: "065-15X-XXXX", // Default phone number
    carRegistration: "999xl", // Add a state to store car registration number (default empty)
  });
            ...
            <div className="white-box">
              <div className="purple-box-inner">
                ...
                <h3 style={{ color: "#FFFFFF" }}>
                  {userData.name ? userData.name : "iice"}
                </h3>
              ...
              <Nav.Item>
                <Link
                  ...
                  className={`nav-item profile-link ${
                    location.pathname === "/profile/edit-member" ? "active" : ""
                  }`}
                >
                  <FontAwesomeIcon
                    icon={faAddressCard}
